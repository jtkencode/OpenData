	...
	**/
	...
	public function index($id=0){
		...
		$this->global_data['breadcumb'][] = array(
			...
			'link'	=> site_url('master/perusahaan')
		);
		$this->global_data['breadcumb'][] = array(
		...
		$config['base_url'] = site_url('master/perusahaan/index');
        ...
        'bidang'			=> $result['BIDANG_PEKERJAAN'],
				'href_view'		=> site_url('master/perusahaan/view/'.$result['ID_PERUSAHAAN']),
				'href_edit'		=> site_url('master/perusahaan/editPerusahaan/'.$result['ID_PERUSAHAAN']),
				'href_delete'	=> site_url('master/perusahaan/deletePerusahaan/'.$result['ID_PERUSAHAAN'])
			);
			$no++;
		}
