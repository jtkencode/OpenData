		...
		<section class="sidebar">
			...
			<div class="user-panel">
				...
				<div class="pull-left info">
					...
					<!-- Status -->
					<a href="<?php echo site_url('master/profile');?>"><i class="fa fa-circle text-success"></i> Online</a>
				</div>
			</div>
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview<?php echo($active_menu=='jurusan' || $active_menu=='prodi')? " active": "";?>">
					...
					<ul class="treeview-menu">
						<li<?php echo($active_menu=='jurusan')? " class=\"active\"": "";?>>
							<a href="<?php echo site_url('master/jurusan');?>">Daftar Jurusan</a>
						</li>
						<li<?php echo($active_menu=='prodi')? " class=\"active\"": "";?>>
							<a href="<?php echo site_url('master/prodi');?>">Daftar Prodi</a>
						</li>
					</ul>
				</li>
				<?php endif; ?>
				...
				<li<?php echo($active_menu=='alumni')? " class=\"active\"": "";?>>
					<a href="<?php echo site_url('master/alumni');?>"><i class="fa fa-user"></i> <span>Alumni</span></a>
				</li>

				<?php if($this->session->userdata('hak')=='admin'): ?>
				<li<?php echo($active_menu=='perusahaan')? " class=\"active\"": "";?>>
					<a href="<?php echo site_url('master/perusahaan');?>"><i class="fa fa-briefcase"></i> <span>Perusahaan</span></a>
				</li>

				<li<?php echo($active_menu=='user' || $active_menu=='user_ubah' || $active_menu=='user_tambah')? " class=\"active\"": "";?>>
					<a href="<?php echo site_url('master/user');?>"><i class="fa fa-user"></i> <span>Pengguna</span></a>
				</li>
				<?php endif; ?>
				<!-- <li class="treeview">
				...
				<li>
					<a href="<?php echo site_url('master/keluar');?>"><i class="fa fa-sign-out"></i> <span>Sign out</span></a>
				</li>
			</ul><!-- /.sidebar-menu -->
		</section>
		<!-- /.sidebar -->
