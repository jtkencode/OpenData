	...
	public function index($id=0){
		...
		foreach ($jurusan as $result) {
			$this->global_data['dataJurusan'][] = array(
				...
				'href_view'		=> site_url('master/jurusan/view/'.$result['ID_JURUSAN']),
				'href_edit'		=> site_url('master/jurusan/editJurusan/'.$result['ID_JURUSAN']),
				'href_delete'	=> site_url('master/jurusan/deleteJurusan/'.$result['ID_JURUSAN'])
			);
			$no++;
		}
