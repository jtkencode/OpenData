	...
	<header class="main-header">
		...
		<!-- Logo -->
		<a href="<?php echo site_url('master'); ?>" class="logo">
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="<?php echo site_url('master/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
								</div>
								<div class="pull-right">
									<a href="<?php echo site_url('master/keluar'); ?>" class="btn btn-default btn-flat">Sign out</a>
								</div>
							</li>
						</ul>
					</li>
