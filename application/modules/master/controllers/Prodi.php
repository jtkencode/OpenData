...
class Prodi extends Main{
	...
	**/
	...
	public function index($id=0){
		...
		$config['base_url'] = site_url('master/prodi/index');
		...
		$this->global_data['href_tambah'] = site_url('master/prodi/addProdi');
		...
		foreach ($prodi as $result) {
			$this->global_data['dataProdi'][] = array(
				...
				'href_view'		=> site_url('master/prodi/view/'.$result['ID_PRODI']),
				'href_edit'		=> site_url('master/prodi/editProdi/'.$result['ID_PRODI']),
				'href_delete'	=> site_url('master/prodi/deleteProdi/'.$result['ID_PRODI'])
			);
			$no++;
